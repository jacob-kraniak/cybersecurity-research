# JsonToolsNppPlugin Security Review

## Engagement Overview

Pro bono community security review of molsonkiko/JsonToolsNppPlugin (Notepad++ JSON tools plugin).

**Scope**:
- Supply chain dependency analysis (Dependabot, Socket, etc.)
